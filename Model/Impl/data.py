...
class CustomDataset(Dataset):
        def __init__(self, dataframe, img_dir, transform=None):
            ...
            self.image_paths = [os.path.join(self.img_dir, img_name) for img_name in self.dataframe.iloc[:, 17]]
...
def load_data(img_dimensions=(224,224), csv_path = "~/gp/dataV5_augmented.csv"):
