...
def load_iNaturalist_model_no_weights():
...
def load(use_extra_perceptron, weights=True):
    model = load_iNaturalist_model() if weights else load_iNaturalist_model_no_weights()
